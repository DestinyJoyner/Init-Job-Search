...
const skillsObject = {
  ...
  // 26: [<SiCli key={uuidv4()} id={26} />, false],
  ...
  // 31: [<SiWos key={uuidv4()} id={31} />, false],
  // 32: [<SiOop key={uuidv4()} id={32} />, false],
  33: [<SiJest key={uuidv4()} id={33} />, false],
  // 34: [<SiAws key={uuidv4()} id={34} />, false],
  // 35: [<SiAzure key={uuidv4()} id={35} />, false],
  // 36: [<SiGcp key={uuidv4()} id={36} />, false],
...
const skillsColorObject = {
  ...
  // 26: <SiCli color={"#F7DF1E"} key={uuidv4()} />,
  ...
  // 31: <SiWos color={"#0078D7"} key={uuidv4()} />,
  // 32: <SiOop color={"#FF4500"} key={uuidv4()} />,
  33: <SiJest color={"#C21325"} key={uuidv4()} />,
  // 34: <SiAws color={"#FF9900"} key={uuidv4()} />,
  // 35: <SiAzure color={"#0089D6"} key={uuidv4()} />,
  // 36: <SiGcp color={"#4285F4"} key={uuidv4()} />,
