...
import "./OldDesktopHomePage.scss"
...
function DesktopHomePage() {
  ...
  return (
    <div className="desktopHome">
        ...
        <div className="desktopHome_header_container">
          ...
          <span className="desktopHome_header_text">
            ...
            <span className="desktopHome_header_text_mission">
              Whether you are an entry-level engineer looking to jump start your
              career in tech, or a recruiter looking to fill entry-level
              positions at a company, inIT is here to connect you!
            </span>
          </span>

          <div className="desktopHome_header_buttons">
            <button
              className="desktopHome_header_buttons_button"
      ...
      <span className="desktopHome_header_disclaimer">
        **{emailInvalid}inIT is was designed in MOBILE VIEW first. Some desktop
        components are currently in the process of being designed. Currently,
        for best viewing of inIT resize the window to under 850px or open in a
        MOBILE browser.{" "}
      </span>
      ...
      <section className="desktopHome_content_init">
        ...
        <div className="desktopHome_header_accountLinks">
          <span className="desktopHome_header_accountLinks_header">
            Begin Your Journey into Tech Today
          </span>
          <Link to="/login">
            <span>LOG IN</span>
          </Link>
        ...
        <section className="desktopHome_content_init_one">
          <div className="desktopHome_content_init_one_text">
            ...
            <p className="desktopHome_content_init_answer">
              ...
              prior work experience. Furthermore, other job search engines,
              harbor a "social media" esque environment that can prove tedious
              and overwhelming.
            </p>
          </div>
        ...
        <section className="desktopHome_content_init_two">
          ...
          <div className="desktopHome_content_init_one_text">
            ...
            <p className="desktopHome_content_init_answer">
              ...
              inIT allows you to showcase your personal and/or professional
              skill set and only hosts opportunities catered to developers with
              little or no professional work experience without the added
              efforts of robust profiles and timeline posts. So{" "}
              <Link to="/register">Register</Link> or{" "}
              <Link to="/login">Login</Link> today, and let inIT help you land
              that critical first opportunity in the tech industry!
            </p>
          </div>
        </section>
      </section>
      ...
      <section className="desktopHome_features grid-center">
        ...
        <span>
          We remove the hassle in beginning your career in tech, connecting you
          directly with opportunities at your skill level.
        </span>

        <section className="desktopHome_features_thumbnails">
          {thumbnailArr.map((obj) => (
            <FeatureThumbnail key={uuidv4()} thumbnailObj={obj} />
          ))}
        </section>
      </section>
